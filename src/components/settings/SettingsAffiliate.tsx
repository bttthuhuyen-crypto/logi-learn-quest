...
export const SettingsAffiliate = () => {
  const { t, formatCurrency, formatDate } = useLanguage();
  const { totalEarned, pendingAmount, availableAmount, totalWithdrawn, isLoading: balanceLoading } = useAffiliateBalance();
  ...
  if (isLoading) {
    return (
      <div className="max-w-4xl p-8 flex items-center justify-center">
  ...
  return (
    <div className="max-w-4xl p-8 space-y-6">
      <div>
        <h1 className="text-2xl font-bold">{t.affiliate.dashboardTitle}</h1>
